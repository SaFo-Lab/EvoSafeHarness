...
# Single-scenario training env: only the telecom domain is vendored, so the
# completeness check below is satisfied by the local ./dataset/telecom tree
...
DATASET_DOMAINS = frozenset({"telecom"})
