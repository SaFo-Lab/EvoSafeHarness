...
# Single-scenario training env: only the os-filesystem domain is vendored, so the
# completeness check below is satisfied by the local ./dataset/os-filesystem tree
...
DATASET_DOMAINS = frozenset({"os-filesystem"})
